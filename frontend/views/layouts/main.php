...
<footer class="footer">
    <div class="footer__container">
        ...
        <nav class="hero-nav hero-nav_footer header-nav_scroll">
            <a href="" class="hero-nav__a" data-id='s3'><?=Yii::t('app','About')?></a>
        ...
        <a href="mailto:<?=Yii::$app->params['adminEmail']?>" class="footer__email"><?=Yii::$app->params['adminEmail']?></a>
        <a href="https://www.facebook.com/NoxUniverse/?ref=aymt_homepage_panel" class="footer__social footer__social_first">
            <img src="img/footer/facebook.png" alt="nox universe facebook">
        </a>
        <a href="https://t.me/noxuniverse" class="footer__social">
